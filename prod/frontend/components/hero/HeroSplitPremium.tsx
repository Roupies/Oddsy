...
export const HeroSplitPremium = () => {
  ...
  return (
    <section 
      ...
      style={{ position: 'relative !important' } as React.CSSProperties}
    >
      <div className="flex flex-col md:flex-row h-full">
        ...
        >
          <div className="max-w-xl w-full">
            ...
            >
              <StatCard 
                value={APP_CONFIG.MODEL_ACCURACY} 
                label="Model Accuracy" 
                trend={APP_CONFIG.DATASET_ACCURACY_RANGE}
                delay={0.5}
              />
              <StatCard 
                value={`${gameweekData?.totalPredictions || 110}+`} 
                label="Predictions Made" 
                trend={`Season ${APP_CONFIG.CURRENT_SEASON}`}
                delay={0.6}
              />
            </motion.div>
            ...
            >
              <p className="text-neutral-500 text-sm font-mono">
                Validated on {gameweekData?.validatedMatches || 100} real EPL matches • Season {APP_CONFIG.CURRENT_SEASON}
              </p>
            </motion.div>
          </div>
        </motion.div>
