...
export const metadata: Metadata = {
  ...
  description: 'AI-powered Premier League match predictions with Enhanced Baseline v3.0',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body className={`${inter.className} bg-neutral-950`} suppressHydrationWarning>
        <Providers>
