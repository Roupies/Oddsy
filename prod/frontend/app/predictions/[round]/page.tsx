...
export default function MatchdayPage({ params }: MatchdayPageProps) {
  ...
  const gameweekData = getDynamicMetrics(round)
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-neutral-400 mb-6">
          Pipeline v1.0 predictions for Matchday {round}
        </p>
      ...
      <div className="mt-12 text-center">
        <div className="card bg-neutral-900/60 border border-neutral-700 max-w-2xl mx-auto backdrop-blur-sm">
          ...
          <div className="text-sm text-neutral-400 space-y-2">
            <p>
              Generated by {APP_CONFIG.PIPELINE_VERSION} using {APP_CONFIG.MODEL_VERSION} with strict temporal validation.
            </p>
            <p>
              All predictions are based on historical data and statistical analysis. 
              Performance validated on {gameweekData.validatedMatches} real EPL matches ({APP_CONFIG.MODEL_ACCURACY} accuracy).
            </p>
