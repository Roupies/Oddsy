        ...
        <div className="text-center space-y-8">
          ...
          <div className="space-y-2">
            <div className="text-2xl font-bold text-white">
              <span className="text-gradient-animate">⚽ Oddsy v2.0</span>
            </div>
            <div className="text-oddsy-secondary font-medium">
              Enhanced Baseline Architecture • Pipeline Durci v1.0
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
            <div className="glass-effect-subtle rounded-lg p-4">
              <div className="text-lg font-bold text-oddsy-secondary">53.5%</div>
              <div className="text-sm text-white/90">Enhanced Baseline v2.4</div>
            </div>
            <div className="glass-effect-subtle rounded-lg p-4">
              <div className="text-lg font-bold text-oddsy-accent">51.7%</div>
              <div className="text-sm text-white/90">Real EPL Accuracy</div>
            </div>
            <div className="glass-effect-subtle rounded-lg p-4">
              <div className="text-lg font-bold text-white">840+</div>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <div className="badge-premium text-white border-white/30">
              ...
              <span>Validated on 60 Real EPL Matches</span>
            </div>
            <div className="badge-premium text-white border-white/30">
              <span className="text-oddsy-secondary">🔒</span>
          ...
          <div className="border-t border-white/20 pt-6 space-y-2">
            <div className="text-sm text-white/80">
              Predictions powered by Enhanced Baseline v2.4 • Pipeline Durci v1.0
            </div>
