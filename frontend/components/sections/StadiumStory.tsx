    ...
    >
      ...
      `}>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="absolute bottom-6 left-6 bg-black/80 backdrop-blur-md border border-emerald-500/20 rounded-lg px-6 py-4"
        >
          <div className="flex gap-6">
            <div>
              <div className="text-3xl font-black text-emerald-500">{winRate}%</div>
              <div className="text-xs text-neutral-400 uppercase tracking-wider">Win Rate</div>
            </div>
            <div>
              <div className="text-3xl font-black text-white">{goals}</div>
              <div className="text-xs text-neutral-400 uppercase tracking-wider">Goals/Game</div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="absolute top-6 right-6 bg-black/50 backdrop-blur-sm rounded-full px-3 py-1">
          <span className="text-white text-xs font-mono uppercase tracking-wider">
            {team.split(' ').slice(-1)[0]} {/* Last word only */}
          </span>
        </div>
      </div>
