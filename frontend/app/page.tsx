        ...
        <section id="model" className="relative z-10 -mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <CardGlass variant="premium" hover="premium" className="text-center group">
              ...
              <div className="text-lg font-semibold text-white mb-2">Enhanced Baseline v2.4</div>
            ...
            <CardGlass variant="premium" hover="premium" className="text-center group">
              ...
              <div className="text-sm text-neutral-400">70 matches validation</div>
            ...
            <CardGlass variant="premium" hover="premium" className="text-center group">
              ...
              <div className="text-sm text-neutral-400">Pipeline Durci v1.0</div>
        ...
        <section className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <CardGlass variant="epl" hover="glow" className="group">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Enhanced Baseline v2.4</h3>
            ...
            <CardGlass variant="epl" hover="glow" className="group">
              <div className="text-4xl mb-4 group-hover:animate-bounce-gentle">⚡</div>
              <h3 className="text-xl font-bold text-white mb-3">Pipeline Durci v1.0</h3>
              <p className="text-neutral-400 mb-4">
            ...
            <CardGlass variant="epl" hover="glow" className="group">
              ...
              <p className="text-neutral-400 mb-4">
                Rigorously tested on 60 real EPL matches with transparent accuracy reporting
              </p>
              <div className="inline-flex items-center text-oddsy-secondary text-sm font-medium">
                <span className="w-2 h-2 bg-oddsy-secondary rounded-full mr-2 animate-pulse"></span>
                Proven Results
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-10">
                <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                  ...
                  <span className="text-sm font-medium">53.5% Accuracy</span>
                </div>
                <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                  <span className="text-oddsy-secondary">🚀</span>
              ...
              <div className="mt-8 pt-8 border-t border-white/20">
                <p className="text-sm opacity-75">
                  Free to use • Updated in real-time • Validated on 60 real EPL matches
                </p>
              </div>
            </div>
          </div>
